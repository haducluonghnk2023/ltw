  ...
  <div class="flex min-h-screen w-[100%] h-[680px]">
    ...
    <div class="hidden md:block w-1/2 bg-image-container">
      <div
        ...
        :style="{
          backgroundImage:
            'url(https://cdn.discordapp.com/attachments/1293910655937679401/1320751691792126033/image.png?ex=676abd5d&is=67696bdd&hm=a54a1ba8794b8dc6ad5a1ecf426647e9fa7ba33434ed222d5bf3f0820c0e162f&)',
        }"
      ></div>
    </div>
  </div>
